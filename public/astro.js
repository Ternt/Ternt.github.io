...
var ASM_CONSTS = {
  85534: () => { if (document.fullscreenElement) return 1; },  
 85580: () => { return Module.canvas.width; },  
 85612: () => { return parseInt(Module.canvas.style.width); },  
 85660: () => { document.exitFullscreen(); },  
 85687: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 85759: () => { if (document.fullscreenElement) return 1; },  
 85805: () => { return Module.canvas.width; },  
 85837: () => { return screen.width; },  
 85862: () => { document.exitFullscreen(); },  
 85889: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 86083: () => { return window.innerWidth; },  
 86109: () => { return window.innerHeight; },  
 86136: () => { if (document.fullscreenElement) return 1; },  
 86182: () => { return Module.canvas.width; },  
 86214: () => { return parseInt(Module.canvas.style.width); },  
 86262: () => { if (document.fullscreenElement) return 1; },  
 86308: () => { return Module.canvas.width; },  
 86340: () => { return screen.width; },  
 86365: () => { return window.innerWidth; },  
 86391: () => { return window.innerHeight; },  
 86418: () => { if (document.fullscreenElement) return 1; },  
 86464: () => { return Module.canvas.width; },  
 86496: () => { return screen.width; },  
 86521: () => { document.exitFullscreen(); },  
 86548: () => { if (document.fullscreenElement) return 1; },  
 86594: () => { return Module.canvas.width; },  
 86626: () => { return parseInt(Module.canvas.style.width); },  
 86674: () => { document.exitFullscreen(); },  
 86701: ($0) => { Module.canvas.style.opacity = $0; },  
 86739: () => { return screen.width; },  
 86764: () => { return screen.height; },  
 86790: () => { return window.screenX; },  
 86817: () => { return window.screenY; },  
 86844: () => { return window.devicePixelRatio; },  
 86880: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86933: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 86984: () => { Module.canvas.style.cursor = 'none'; },  
 87021: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 87277: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 87328: () => { if (document.pointerLockElement) return 1; },  
 87375: () => { if (document.fullscreenElement) return 1; },  
 87421: () => { return window.innerWidth; },  
 87447: () => { return window.innerHeight; }
};
